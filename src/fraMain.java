...
public class fraMain {
    ...
    // 点击用户下拉框才会跳转页面
    //
    public static void UserMenu(JMenuBar menubar){
        ...
        Userbar.Useruse(userInformation,userEXIT,usermodify);
    }//个人中心:查看个人信息*，退出登录查
    public static  void HallMenu(JMenuBar menubar){
        ...
        Hallbar.Hallmenu(catlook);
    }//大厅:查阅，筛选#
    public static void PublishMenu(JMenuBar menubar){
    ...
    public static void startfraMain( JFrame frame){
